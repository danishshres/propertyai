...
def run_elevation_risk_assessment(address: PropertyAddress):
    ...
    file_path = file_repo.save(property_address=address, data=elevation_risk, filename='elevation_risk.json')
